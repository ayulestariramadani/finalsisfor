                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $comp['nama_perusahaan'] ?></td>
                                        <td><?php echo $comp['notlp_perusahaan'] ?></td>
                                        <td><?php echo $comp['email_perusahaan'] ?></td>
                                        <td><?php echo $comp['alamat_perusahaan'] ?></td>
                                        <td>
                                        	<a href="<?php echo site_url('admin/edit/'.$comp['id_perusahaan']) ?>">
                                                <button type="button" class="btn btn-success waves-effect">
			                                         <i class="material-icons">create</i>
			                                    </button>
                                            </a>
                                            <a href="<?php echo site_url('admin/delete/'.$comp['id_perusahaan']) ?>">
